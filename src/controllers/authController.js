...
const recoveryPassword = async (req, res) => {
    ...
    try {
        ...
        if (user) {
            ...
            res.status(200).send({
                message: 'Si existe, recibirás en tu correo electrónico el código para modificar tu cuenta'
            })
        ...
        res.status(200).send('Si existe, recibirás en tu correo electrónico el código para modificar tu cuenta');
